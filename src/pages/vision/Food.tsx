        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="aspect-[4/3] rounded-md border flex items-center justify-center overflow-hidden bg-muted/30">
              <div className="text-sm text-muted-foreground">No preview shown for this mode</div>
            </div>
          ...
          <CardContent>
            <Tabs defaultValue="results">
              ...
              <TabsContent value="results" className="space-y-3 mt-4">
                <div className="rounded-md border">
                  <div className="grid grid-cols-2 px-3 py-2 text-xs text-muted-foreground border-b">
                    <span>Label</span><span>Confidence</span>
                  </div>
              ...
              <TabsContent value="raw" className="mt-4">
                <pre className="text-xs whitespace-pre-wrap text-muted-foreground">{JSON.stringify({ mode: "food-classification", results: [{ label: "Italian Cuisine", confidence: 0.95 }] }, null, 2)}</pre>
              </TabsContent>
            </Tabs>
          </CardContent>
        </Card>
